...
info ""
info "  apt: wl-clipboard              — clipboard tool for Wayland (used at paste step)"
...
info ""
info "  pip: faster-whisper  — AI speech recognition engine (core feature)"
...
info ""
info "  sudo apt remove wl-clipboard libportaudio2 portaudio19-dev \\"
info "       gir1.2-ayatanaappindicator3-0.1"
info ""
info "  pip uninstall faster-whisper sounddevice evdev python-dotenv"
info ""
